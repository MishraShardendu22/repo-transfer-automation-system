...
// AppServer configuration and in-memory session store
...
func (s *AppServer) Handler() http.Handler {
	...
	mux.HandleFunc("/api/auth/login", s.HandleOAuthLogin)
	mux.HandleFunc("/api/auth/callback", s.HandleOAuthCallback)
